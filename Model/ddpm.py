...
class DDPMSampler:
    ...
    def __init__(self, generator: torch.Generator, num_training_steps=1000, beta_start: float = 0.00085,
        ...
        self.timesteps = torch.flip(torch.arange(0, num_training_steps, dtype=torch.int64), dims=[0])


    def set_inference_timesteps(self, num_inference_steps=50):
        self.num_inference_steps = num_inference_steps
        step_ratio = self.num_train_timesteps // self.num_inference_steps
        timesteps = torch.flip(torch.arange(0, num_inference_steps, dtype=torch.int64) * step_ratio, dims=[0])
